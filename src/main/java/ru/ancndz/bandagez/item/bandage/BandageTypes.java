...
public enum BandageTypes implements BandageType {
    ...
    ANTI_BIOTIC(50,
            List.of(RegistryObject.create(ResourceLocation.withDefaultNamespace("poison"),
                    ForgeRegistries.MOB_EFFECTS))),

    MAGIC(50,
            List.of(RegistryObject.create(ResourceLocation.withDefaultNamespace("wither"),
                    ForgeRegistries.MOB_EFFECTS))),

    STIMULANT(50, List.of(
            RegistryObject.create(ResourceLocation.withDefaultNamespace("mining_fatigue"), ForgeRegistries.MOB_EFFECTS),
            RegistryObject.create(ResourceLocation.withDefaultNamespace("slowness"), ForgeRegistries.MOB_EFFECTS))),
