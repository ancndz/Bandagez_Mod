 ...
 *
 * // The purpose of this method is to be called in the mod's constructor, in order to assure that the class is loaded,
 * // and that objects can be registered.
 * public static void loadClass() {
 * }
 * }</pre>
 *
 * @param <T>
 *            the type of the objects that this class registers
 */
public interface RegistrationProvider<T> {
     ...
     * {@link Factory#INSTANCE factory} creating multiple providers for the same resource key and mod id.
     *
     * @param resourceKey
     *            the {@link ResourceKey} of the registry of the provider
     * @param modId
     *            the mod id that the provider will register objects for
     * @param <T>
     ...
     *
     * @param registry
     *            the {@link Registry} of the provider
     * @param modId
     *            the mod id that the provider will register objects for
     * @param <T>
     *            the type of the provider
     ...
     * @param supplier
     *            a supplier of the object to register
     * @param <I>
     *            the type of the object
     * @return a wrapper containing the lazy registered object. <strong>Calling {@link RegistryObject#get() get} too
     *         early on the wrapper might result in crashes!</strong>
     */
     ...
     * This class is loaded using {@link ServiceLoader Service Loaders}, and only one should exist per mod loader.
     */
    interface Factory {
         ...
         */
        Factory INSTANCE = PlatformServices.load(Factory.class);

        /**
         * Creates a {@link RegistrationProvider}.
         *
         * @param resourceKey
         *            the {@link ResourceKey} of the registry to create this provider for
         * @param modId
         *            the mod id for which the provider will register objects
         * @param <T>
         *            the type of the provider
         * @return the provider
         */
         ...
         *
         * @param registry
         *            the {@link Registry} to create this provider for
         * @param modId
         *            the mod id for which the provider will register objects
         * @param <T>
         *            the type of the provider
